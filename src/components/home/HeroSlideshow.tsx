...
const slides = [
  {
    ...
    cta: { label: "Read First Chapter Free", href: "/free-story" },
  ...
  },
  {
    ...
    eyebrow: "Free Short Story",
    headline: "The Last Witness",
    authorHook: "A mind can forget — but the truth remembers. Get the free story now.",
    quote: { text: "Hooked from the first page. I stayed up until 3am. This is exactly the kind of dark fiction I've been looking for.", attribution: "@darkfictionlover · Newsletter Subscriber" },
    cta: { label: "Get the Free Story", href: "/free-story" },
