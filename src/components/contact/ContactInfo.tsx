...
export function ContactInfo() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="font-serif text-2xl font-semibold text-brand-charcoal mb-4">
          Let&apos;s Connect
        </h2>
      ...
      <div className="space-y-5">
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-sm font-semibold text-brand-charcoal mb-0.5">Email</p>
            <a
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-sm font-semibold text-brand-charcoal mb-0.5">Response Time</p>
      ...
      <div>
        <p className="text-xs font-semibold uppercase tracking-widest text-brand-charcoal/40 mb-4">
          Find me online
        </p>
        <div className="flex gap-4">
          <a
            ...
            className="w-10 h-10 rounded-full bg-brand-greige/40 flex items-center justify-center text-brand-charcoal/60 hover:bg-brand-gold hover:text-brand-cream transition-all duration-200"
          >
      ...
      <div className="bg-brand-greige/30 rounded-card p-6 border border-brand-greige/50">
        <p className="font-serif italic text-brand-charcoal/70 text-sm leading-relaxed">
